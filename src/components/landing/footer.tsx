...
export default function Footer() {
    return (
        <>
            <div className="sticky -z-0 bottom-0 left-0 w-full h-80 bg-phosphor flex justify-center items-center">
                <div className="relative overflow-hidden w-full h-full flex justify-end px-8 text-right items-start py-12 text-black">
                    ...
                    <img className='absolute bottom-0 left-0 md:left-8  translate-y-[1%] w-full md:w-1/2' src="/og-images/full-logo-black.svg" alt="Tactix logo" />
                </div>
            </div>
        </>
    )
