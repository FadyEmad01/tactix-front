...
export default function Footer() {
    return (
        <>
            <div className="sticky -z-0 bottom-0 left-0 w-full h-80 bg-black dark:bg-white flex justify-center items-center">
                <div className="relative overflow-hidden w-full h-full flex justify-end px-8 text-right items-start py-12 text-white dark:text-black">
                    ...
                    <Image width={0} height={0} className='absolute bottom-0 left-0 md:left-8  translate-y-[1%] w-full md:w-1/2 dark:invert' src="/og-images/full-logo.svg" alt="Tactix logo" />
                </div>
            </div>
        </>
    )
