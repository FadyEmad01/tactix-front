  ...
  return (
    ...
    >
      ...
      <svg
        ...
        fill="none"
      >
        {/* Base Ball Outline & Fill */}
        <circle cx="50" cy="50" r="46" fill="#f8fafc" stroke="#1e293b" strokeWidth="5" />
        
        {/* Center Pentagon */}
        <polygon 
          points="50,31 32,44 39,65 61,65 68,44" 
          fill="#1e293b" 
          stroke="#1e293b" 
          strokeWidth="2" 
        ...
        {/* Radiating Seams */}
        <line x1="50" y1="31" x2="50" y2="4" stroke="#1e293b" strokeWidth="4.5" strokeLinecap="round" />
        <line x1="32" y1="44" x2="6" y2="32" stroke="#1e293b" strokeWidth="4.5" strokeLinecap="round" />
        <line x1="68" y1="44" x2="94" y2="32" stroke="#1e293b" strokeWidth="4.5" strokeLinecap="round" />
        <line x1="39" y1="65" x2="23" y2="85" stroke="#1e293b" strokeWidth="4.5" strokeLinecap="round" />
        <line x1="61" y1="65" x2="77" y2="85" stroke="#1e293b" strokeWidth="4.5" strokeLinecap="round" />
      </svg>
    </div>
  );
});
